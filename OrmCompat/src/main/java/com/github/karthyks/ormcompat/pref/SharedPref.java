...
public class SharedPref implements ISharedPrefClient {
  ...
  @CheckResult
  public static ISharedPrefClient get(
  ...
  @Nullable private IPreferenceAdapter getAdapter(Object t) {
    if (t instanceof Boolean) {
      return IPreferenceAdapter.BOOLEAN_ADAPTER;
    } else if (t instanceof String) {
      return IPreferenceAdapter.STRING_ADAPTER;
    } else if (t instanceof Float) {
      return IPreferenceAdapter.FLOAT_ADAPTER;
    } else if (t instanceof Long) {
      return IPreferenceAdapter.LONG_ADAPTER;
    } else if (t instanceof Integer) {
      return IPreferenceAdapter.INT_ADAPTER;
    }
    return null;
  }
  ...
  public void putValue(@NonNull String key, @Nullable Object value) {
    ...
    IPreferenceAdapter adapter = getAdapter(value);
    if (adapter == null) {
  ...
  public <T> T getValue(@NonNull String key, @NonNull T type) {
    ...
    IPreferenceAdapter<T> adapter = getAdapter(type);
    if (adapter == null)
      throw new IllegalArgumentException("Unsupported value type "
